...
public class Client extends Thread { 
    public static boolean doneSending = false;
     ...
     */
     public void sendTransactions()
     {
        ...
        //	{ 
         ...
         // }
           // System.out.println("\n Sending transaction " + (i + 1) + "/" + getNumberOfTransactions());        	
     ...
     */
     public void receiveTransactions(Transactions transact)
     {
         ...
         {   
        	...
        	//	 
        	 //}
           // System.out.println("\n Receving transaction " + (i + 1) + "/" + getNumberOfTransactions());
     ...
     */
     ...
     /* Implement the code for the run method */
         ...
         if (this.getClientOperation().equals("sending")) { //If this is the sending client..
         ...
         if (this.getClientOperation().equals("receiving")) { //If this is the receiving client..
             ...
             Network.disconnect(Network.getClientIP()); //Only set the client connection status to "disconnected" when we've finished receiving.
