...
public class Network extends Thread{
    ...
    {	
		...
		/* Implement the code for the run method */
    		 ...
    		 if (this.getClientConnectionStatus().equals("disconnected") && this.getServerConnectionStatus().equals("disconnected")) { //If both server and client are disconnected, terminate. Otherwise yield.
