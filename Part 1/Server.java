...
public class Server extends Thread{
     ...
     */
     ...
     {   int accIndex;             	/* Index position of account to update */
         ...
         { 
        	 while( (objNetwork.getInBufferStatus().equals("empty"))) {Thread.yield(); if (objNetwork.getClientConnectionStatus().equals("disconnected")) break;}   /* Alternatively, busy-wait until the network input buffer is available */
    ...
    {   Transactions trans = new Transactions();
    	...
    	this.processTransactions(trans); //Process the transactions until there's nothing left, then proceed to disconnect.
